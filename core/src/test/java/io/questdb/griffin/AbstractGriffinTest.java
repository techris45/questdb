...
public abstract class AbstractGriffinTest extends AbstractCairoTest {
    ...
    protected TableToken createPopulateTable(
        ...
        return TestUtils.createPopulateTable(compiler, sqlExecutionContext, tableModel, totalRows, startDate, partitionCount);
    }
    ...
    protected TableToken createPopulateTable(
        ...
        try (
            ...
            TableUtils.createTable(configuration, mem, path, false, tableModel, tableId, tableToken.getDirName());
